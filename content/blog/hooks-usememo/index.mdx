...
According to the React docs, `useMemo` is meant to be a **performance optimization**. They suggest you get your code to work without `useMemo` and implement it after the fact.
