...
Even though I'm still getting my streaming legs under me and building out my kit, that doesn't mean there aren't some things I can already do by using OBS scenes in order to polish the visual aspect of my broadcasts.
...
For example, I usually like to check my [Mixer channel](https://mixer.com/ryanharris/) before I start in order to make the broadcast is working, but I don’t really want the viewers to see me doing that (he’s so vain!). This scene would allow me to do that by simply displaying a graphic instead of my desktop.
