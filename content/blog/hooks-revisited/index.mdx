...
Now, I work in a codebase that was all written after developers started shifting to hooks and I want to better understand how **all** of them work, as well as when to use them.
