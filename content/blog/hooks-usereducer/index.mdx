...
- Storing our input values in refs instead of useReducer as changing the value of a ref does not cause our component to re-render (see my <Link to="/hooks-useref">useRef</Link> article for more on this).
